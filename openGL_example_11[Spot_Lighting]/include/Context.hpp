...
void    Context::Render(void)
{
    if (ImGui::Begin("ui window", 0, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::CollapsingHeader("Light", ImGuiTreeNodeFlags_DefaultOpen))
        {
            ...
            ImGui::DragFloat("Light Cutoff", &this->m_light.cutoff[0], 0.5f, 0.0f, 89.9f);
            ImGui::DragFloat("Light Delta Cutoff", &this->m_light.cutoff[1], 0.5f, 0.0f, 90.0f - this->m_light.cutoff[0]);
